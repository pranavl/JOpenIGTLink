...
public abstract class OpenIGTServer {
     ...
     * @param errorManager main class running this server
     * @throws Exception
     *
     *************************************************************************
     */
     ...
     *
     * @param serverThread serverThread managing connection of client where does
     * come from the message ** @return the message Handler
     */
