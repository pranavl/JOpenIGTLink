...
public class Header {
    ...
    // ------------------------------------------------------------------------
    /**
     *** Destination Constructor ** @param version ; // Version number unsigned
     * int 16bits
     *
    ...
    // ------------------------------------------------------------------------
    /**
     *** Destination Constructor ** @param bytes bytes doit contenir 58 bytes
     * of the header
     *
     */
    ...
    // ------------------------------------------------------------------------
    /**
     *** Version number. ** @return The current version of the bytesArray
     *
     */
    ...
    // ------------------------------------------------------------------------
    /**
     *** Type name of data ** @return The type of the device
     *
     */
    ...
    // ------------------------------------------------------------------------
    /**
     *** Unique device name. ** @return The current name of the device
     *
     */
    ...
    // ------------------------------------------------------------------------
    /**
     *** TimeStamp or 0 if unused. ** @return The time stamp at the creation of
     * the header
     *
     */
    ...
    // ------------------------------------------------------------------------
    /**
     *** Size of body in bytes. ** @return The current body_size of the
     * bytesArray
     *
     */
    ...
    // ------------------------------------------------------------------------
    /**
     *** 64 bit CRC for body data. ** @return The current crc of the bytesArray
     *
     */
    public long getCrc() {
        return this.crc;
    ...
    // ------------------------------------------------------------------------
    /**
     *** ByteArray which contain header bytes. ** @return The current
     * bytesArray
     *
     */
    ...
    /**
     *** this header bytes. ** @return A copy of the byte array currently in
     * the bytesArray (as-is)
     *
     */
