...
public abstract class OpenIGTMessage {
    ...
    /**
     *** Constructor to be used to build messages from incoming bytes ** @param
    ...
    public boolean Unpack() throws Exception {
        if (getBody().length > 0 //&& !isBodyUnpacked
                ) {
    ...
    /**
     *** Unique device name. ** @return The name of the device
         *
     */
    ...
    /**
     *** header. ** @return bytes array containing the header of the message
         *
     */
    ...
    /**
     *** body. ** @return bytes array containing the body of the message
         *
     */
    public byte[] getBody() {
        if (body == null) {
    ...
    /**
     *** Bytes to be sent. ** @return bytes array containing the message
         *
     */
    ...
    /**
     *** To get message String ** @return the message String
     */
