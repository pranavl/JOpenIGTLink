...
/**
 *** This class create an Transform object from bytes received or help to
...
public class TransformMessage extends OpenIGTMessage {
     ...
     * getBytes to send them ** @param deviceName Device Name
         *
     */
    ...
    /**
     *** To create transform_data from image characteristics and to get the
     * byte array to send
     *
     * @param origin
     * @param normals ** @return the bytes array created from the value
     */
    ...
    /**
     *** To get transform_data byte array ** @return the transform_data bytes
     * array
     */
    ...
    /**
     *** To get Image origin ** @return the origin bytes array
     */
    ...
    /**
     *** To get Image normals ** @return the normals matrix
     */
    ...
    /**
     *** To get Image matrix ** @return the image matrix
     */
    ...
    /**
     *** To get transform String ** @return the transform String
     */
    @Override
